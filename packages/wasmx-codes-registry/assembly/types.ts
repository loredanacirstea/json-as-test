...
// instead of the above import of types, if you copy the types in this same page, there is no out of bounds error
...
export class GenesisState {
    code_infos: CodeInfo[] = new Array<CodeInfo>(0)
    contract_infos: MsgSetContractInfoRequest[] = new Array<MsgSetContractInfoRequest>(0)
    constructor(code_infos: CodeInfo[] = [], contract_infos: MsgSetContractInfoRequest[] = []) {
        console.log("GenesisState.constructor")
...
export class MsgSetContractInfoRequest {
    ...
    constructor(address: Bech32String, contract_info: ContractInfo) {
        console.log("MsgSetContractInfoRequest.constructor")
        this.address = address
